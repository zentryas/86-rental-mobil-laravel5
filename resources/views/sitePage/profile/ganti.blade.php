...
@section('title','86Rentcar Yogyakarta | Ganti Password')
@section('content')
<!--== Banner Area Start ==-->
<div class="container-fluid mt-5">
    <div class="row">
        <img src="{{ asset('frontend/img/banner/booking.jpg')}}" class="banner" alt="...">
    </div>
</div>
<!--== Banner Area End ==-->
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nomor_hp" type="text" class="form-control @error('nomor_hp') is-invalid @enderror" name="nomor_hp" value="{{ $user->nomor_hp }}" required autocomplete="nohp" autofocus>
