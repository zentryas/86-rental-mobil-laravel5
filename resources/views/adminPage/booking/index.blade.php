...
@section('title','Transaksi Booking | 86Rentcar Yogyakarta')
@section('content')
...
<div class="content-header mt-5">
    <div class="container-fluid">
        <div class="row mt-2">
            <div class="col-sm-6">
                <h5 class="m-0 text-dark"> <i class="fa fa-info-circle"></i> Info Booking Mobil</h5>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                    <li class="breadcrumb-item active">Info Booking Mobil</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
