...
@section('title','Informasi Pembayaran DP Kadaluarsa | 86Rentcar Yogyakarta')
@section('content')
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 mt-3">
                <h5 class="m-0 text-dark"> <i class="fa fa-info-circle"></i> Informasi Pembayaran DP Kadaluarsa</h5>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                    <li class="breadcrumb-item active">Informasi Pembayaran DP Kadaluarsa</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
